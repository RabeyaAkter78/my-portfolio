...
<div id="projects" className="w-full pt-10 pb-20 px-2" >
          ...
          data-aos-duration="1000"
           className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-10 md:gap-8 lg:gap-6 items-center md:ml-16 lg:ml-2">
                <div className="card w-72 h-80  md:w-96 md:h-96 bg-slate-400 px-2 lg:px-4 py-3 lg:py-4 rounded-lg shadow-2xl bg-gradient-to-r from-transparent via-transparent to-neutral-700  group-hover:bg-gradient-to-b hover:from-gray-500 hover:bg-gray-700 transition-colors duration-1000">
                    <figure>
